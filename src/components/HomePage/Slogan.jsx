...
const Slogan = () => {
  return (
    <div className="flex flex-col md:flex-row p-6 md:p-10 bg-gradient-to-br from-indigo-200 via-purple-300 to-pink-200 shadow-2xl rounded-3xl border border-gray-200 mx-auto w-full max-w-7xl">
      {/* Logo Section */}
